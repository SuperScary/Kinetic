...
public class DraftingTableRenderer implements BlockEntityRenderer<DraftingTableBlockEntity>
{

    public DraftingTableRenderer (BlockEntityRendererProvider.Context context)
    {

    }

    @Override
    public void render (DraftingTableBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay)
    {
