...
public class CoalGeneratorMenu extends AbstractContainerMenu
{
    ...
    public CoalGeneratorMenu (int containerId, Inventory inventory, BlockEntity entity, ContainerData data)
    {
        super(KineticMenus.COAL_GENERATOR_MENU.get(), containerId);
    ...
    {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, KineticBlocks.COAL_GENERATOR.get());
    }
