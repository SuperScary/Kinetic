...
public class SawmillMenu extends AbstractContainerMenu
{
    ...
    {
        super(KineticMenus.SAWMILL_MENU.get(), containerId);
    ...
    {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, KineticBlocks.COMPRESSOR.get());
    }
