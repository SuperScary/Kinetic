...
public class PremiumPowerCableBakedModel implements IDynamicBakedModel
{
    ...
    public PremiumPowerCableBakedModel (IGeometryBakingContext context, boolean facade)
    {
    ...
    private void initTextures ()
    {
        ...
        {
            spriteConnector = getTexture("block/cable/power/premium/connector");
            spriteNormalCable = getTexture("block/cable/power/premium/normal");
            spriteNoneCable = getTexture("block/cable/power/premium/none");
            spriteEndCable = getTexture("block/cable/power/premium/end");
            spriteCornerCable = getTexture("block/cable/power/premium/corner");
            spriteThreeCable = getTexture("block/cable/power/premium/three");
            spriteCrossCable = getTexture("block/cable/power/premium/cross");
            spriteSide = getTexture("block/cable/power/premium/side");
        }
    }
