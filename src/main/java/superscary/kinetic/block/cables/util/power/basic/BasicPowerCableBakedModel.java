package superscary.kinetic.block.cables.util.power.basic;
...
public class BasicPowerCableBakedModel implements IDynamicBakedModel
{
    ...
    public BasicPowerCableBakedModel (IGeometryBakingContext context, boolean facade)
    {
    ...
    private void initTextures ()
    {
        ...
        {
            spriteConnector = getTexture("block/cable/power/basic/connector");
            spriteNormalCable = getTexture("block/cable/power/basic/normal");
            spriteNoneCable = getTexture("block/cable/power/basic/none");
            spriteEndCable = getTexture("block/cable/power/basic/end");
            spriteCornerCable = getTexture("block/cable/power/basic/corner");
            spriteThreeCable = getTexture("block/cable/power/basic/three");
            spriteCrossCable = getTexture("block/cable/power/basic/cross");
            spriteSide = getTexture("block/cable/power/basic/side");
        }
    }
