...
public class DeluxePowerCableBakedModel implements IDynamicBakedModel
{
    ...
    public DeluxePowerCableBakedModel (IGeometryBakingContext context, boolean facade)
    {
    ...
    private void initTextures ()
    {
        ...
        {
            spriteConnector = getTexture("block/cable/power/deluxe/connector");
            spriteNormalCable = getTexture("block/cable/power/deluxe/normal");
            spriteNoneCable = getTexture("block/cable/power/deluxe/none");
            spriteEndCable = getTexture("block/cable/power/deluxe/end");
            spriteCornerCable = getTexture("block/cable/power/deluxe/corner");
            spriteThreeCable = getTexture("block/cable/power/deluxe/three");
            spriteCrossCable = getTexture("block/cable/power/deluxe/cross");
            spriteSide = getTexture("block/cable/power/deluxe/side");
        }
    }
