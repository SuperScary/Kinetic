package superscary.kinetic.block.cables.util.power.ultimate;
...
public class UltimatePowerCableBakedModel implements IDynamicBakedModel
{
    ...
    public UltimatePowerCableBakedModel (IGeometryBakingContext context, boolean facade)
    {
    ...
    private void initTextures ()
    {
        ...
        {
            spriteConnector = getTexture("block/cable/power/ultimate/connector");
            spriteNormalCable = getTexture("block/cable/power/ultimate/normal");
            spriteNoneCable = getTexture("block/cable/power/ultimate/none");
            spriteEndCable = getTexture("block/cable/power/ultimate/end");
            spriteCornerCable = getTexture("block/cable/power/ultimate/corner");
            spriteThreeCable = getTexture("block/cable/power/ultimate/three");
            spriteCrossCable = getTexture("block/cable/power/ultimate/cross");
            spriteSide = getTexture("block/cable/power/ultimate/side");
        }
    }
    ...
    {
        return Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS).apply(new ResourceLocation(Kinetic.MODID, path));
    }
